...
class WpRetinaImage_OptionsManager {
	...
	public function settingsPage() {
		if (!current_user_can('manage_options')) {
			wp_die(__('You do not have sufficient permissions to access this page.', 'wp-retina-image'));
		}
		...
		<div class="wrap">
			...
			<div class="donate">
				<h3>DONATE</h3>
				<div class="bitcoin">
					<p><?php _e('Software development donation is a bit coin with less commission.', 'wp-retina-image') ?></p>
					<div class="address">1Lmbf9bbBMst1tRLCRktHHDnwEhgiMJwcM</div>
					<div class="qr">
						<img src="<?php echo(plugins_url()); ?>/wp-retina-image/img/donate_qr.jpg" alt="1Lmbf9bbBMst1tRLCRktHHDnwEhgiMJwcM">
					</div>
				</div>
			</div>
			<h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'wp-retina-image'); ?></h2>
			...
			<?php settings_fields($settingsGroup); ?>
				...
				<p class="submit">
					<input type="submit" class="button-primary"
						   value="<?php _e('Save Changes', 'wp-retina-image') ?>"/>
				</p>
			</form>
		</div>
		<?php
	...
	protected function getOptionValueI18nString($optionValue) {
		switch ($optionValue) {
			case 'true':
				return __('true', 'wp-retina-image');
			case 'false':
				return __('false', 'wp-retina-image');

			case 'Administrator':
				return __('Administrator', 'wp-retina-image');
			case 'Editor':
				return __('Editor', 'wp-retina-image');
			case 'Author':
				return __('Author', 'wp-retina-image');
			case 'Contributor':
				return __('Contributor', 'wp-retina-image');
			case 'Subscriber':
				return __('Subscriber', 'wp-retina-image');
			case 'Anyone':
				return __('Anyone', 'wp-retina-image');
		}
		return $optionValue;
	}
